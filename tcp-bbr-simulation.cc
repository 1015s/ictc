...
NS_LOG_COMPONENT_DEFINE("TcpBbrCongestionTest1Gbps");

// RTT를 추적하고 파일에 기록하는 함수
void RttTracer(Time oldRtt, Time newRtt)
{
    static std::ofstream rttFile("rtt-oscillation-bbr-1Gbps-congested.csv", std::ios::out | std::ios::app);
...
int main(int argc, char *argv[])
{
    ...
    // 로그 활성화
    LogComponentEnable("TcpBbrCongestionTest1Gbps", LOG_LEVEL_INFO);
    ...
    onOffHelper.SetAttribute("DataRate", StringValue("1.5Gbps"));
