...
{
    static std::ofstream rttFile("rtt-tcpdo-loss.csv", std::ios::out | std::ios::app);
...
{
    static std::ofstream throughputFile("throughput-tcpdo-loss.csv", std::ios::out | std::ios::app);
