...
{
    static std::ofstream rttFile("rtt-tcpbbr-wired.csv", std::ios::out | std::ios::app);
...
{
    static std::ofstream throughputFile("throughput-tcpbbr-wired.csv", std::ios::out | std::ios::app);
